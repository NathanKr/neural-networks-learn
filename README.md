...
<li>learning curves (learning_curves.png , <a href="https://github.com/NathanKr/neural-networks-learn/releases/tag/1.3">tag</a>): 1. data set of 200 sampling was enough to get ~ 5% 2. prediction of test and training is almost the same which is very good - no variance problem thus no need for regularization </li>
</ul>
